...
//	[MenuItem("工具/AssetBundle/设置AssetStreaming资源路径")]
//	static void SetObjAssetStreamingSetting(){
//		object[] gameObjects;

//		gameObjects = Object.FindSceneObjectsOfType(typeof(GameObject));
...
//	//设置AssetBundle资源路径
//	[MenuItem("工具/AssetBundle/设置AssetBundle资源路径")]
...
//	[MenuItem("工具/AssetBundle/设置打包标签")]
...
//				//if(Config.ImageType.Contains(aLastName)){
...
//	[MenuItem("工具/AssetBundle/清除打包标签")]
...
//	[MenuItem("工具/AssetBundle/创建一个IOS文件夹，AssetBundle文件都放在里面")]
...
//	[MenuItem("工具/AssetBundle/创建一个Android文件夹，AssetBundle文件都放在里面")]
...
//	[MenuItem("工具/AssetBundle/压缩图片为32")]
//	public static void SetPicture32(){
//		SetImportTexture (32);
//	}

//	[MenuItem("工具/AssetBundle/压缩图片为2048")]
